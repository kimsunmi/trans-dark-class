...
setup: $(TARGET_SETUP) $(TARGET_COMMIT)
open: $(TARGET_OPEN)
...
$(TARGET_COMMIT): $(TEST_CODE_DIR)commit_test.c
	$(CC) -o $@ $(TEST_CODE_DIR)commit_test.c $(SOURCE_DIR)polynomial_commit.c $(SOURCE_DIR)polynomial_open_verify.c $(SOURCE_DIR)util.c $(SOURCE_DIR)codeTimer.c $(CFLAGS) 
